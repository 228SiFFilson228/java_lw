public class Product {
  ...
  public Product(int id, String title, int UPC, String Manufacturer, int cost, int valid_until, int amount) throws Exception {
    checkStringCorrectness(title);
    checkStringCorrectness(Manufacturer);
    this.id = id;
    this.title = title;
    this.UPC = UPC;
